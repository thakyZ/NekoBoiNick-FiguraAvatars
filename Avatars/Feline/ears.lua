-- config --
local config = {
    leftEar = models.Feline.Head.Ears.Left, -- model part of left ear
    rightEar = models.Feline.Head.Ears.Right, -- model part of right ear

    velocityStrength = 1,

    extraAngle = 30, -- rotates ears by this angle when crouching
